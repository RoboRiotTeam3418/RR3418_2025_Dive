...
public class LookAtCringeCmd extends Command {
   ...
   */
  public LookAtCringeCmd(SwerveSubsystem Veer, Limelight limejuice, int SelPipeline, double distance, double traget, double TargetDB) {
