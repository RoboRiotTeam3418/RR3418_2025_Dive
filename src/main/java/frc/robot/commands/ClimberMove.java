...
public class ClimberMove extends Command {
  ...
  public void execute() {
    ...
    if (DeadbandUtils.isWithin(m_subsystem.enc1.getPosition(), m_subsystem.enc2.getPosition(), 2.5)
        && DeadbandUtils.isWithin(m_subsystem.enc2.getPosition(), m_subsystem.enc1.getPosition(), 2.5)
