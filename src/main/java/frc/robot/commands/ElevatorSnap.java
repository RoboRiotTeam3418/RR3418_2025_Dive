...
public class ElevatorSnap extends Command {
  ...
  public void execute() {   
    ...
    if(Deadbands.isOutside(m_subsystem.goalToDistance(m_subsystem.goalheight),m_subsystem.getElevPosition(),allowance) &&  (Setup.getInstance().getSecondaryMoveElev()||m_override)){
