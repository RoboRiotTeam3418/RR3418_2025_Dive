...
public class ElevatorSnap extends Command {
   ...
   * @param int the goal height of the elevator.
   */

  public ElevatorSnap(Elevator subsystem, int goalheight) {
  ...
  @Override
  public void execute() {    
    if (m_goalheight!= m_subsystem.height &&  Setup.getInstance().getSecondaryMoveElev()){
